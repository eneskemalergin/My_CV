...
{\em Bioinformatics}
\begin{list1}
\item[]  MSc, Bioinformatics, 2017 - 2020
% \begin{list2}
% \vspace*{.05in}
% \item {\bf Advisor:}  Philipp Lange
% \item {\bf Dissertation Topic:}  ``Rapid and transparent classification of pediatric tumor biopsies by using artificial intelligence guided protein mass spectrometry''
...
\vspace{-.3cm}
\begin{list2}
\item Research: Statistical approaches to classification of pediatric tumor biopsies based on apparent and hidden proteome features.
\end{list2}
