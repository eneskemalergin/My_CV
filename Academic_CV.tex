...
{\it Work:} 604-875-2000 ext:7146   & \hfill {\it E-mail:}  \href{mailto:eneskemalergin@gmail.com}{eneskemalergin@gmail.com}\\
                                    & \hfill {\it Portfolio:}  \href{https://eneskemalergin.github.io}{eneskemalergin.github.io} \\
                                    & \hfill {\it LinkedIn:}  \href{https://www.linkedin.com/in/eneskemalergin/}{eneskemalergin} \\
\end{tabular}
...
\vspace{-.3cm}
\begin{list2}
\item Maintaining and developing computational infrastructure for large-scale proteomics data analysis; ongoing statistical method development and application of machine learning approaches to childhood cancer research.
\end{list2}
...
\item {\bf Aim 1:} To expand statistical explainability through equivalence testing.
      (\href{https://github.com/LangeLab/Analysis_of_QuEStVar_Manuscript}{QuEStVar},~\href{https://doi.org/10.1021/acs.jproteome.4c00131}{Paper})
\item {\bf Aim 2:} To enhance peptide-level identification and quantification in proteomics data.
      (\href{https://github.com/LangeLab/SQuAPP}{SQuAPP},~\href{https://doi.org/10.1093/bioinformatics/btac628}{Paper})
\item {\bf Aim 3:} To identify quantitatively distinct proteoforms at the peptide level in Neuroblastoma.
      (\href{https://github.com/LangeLab/ProteoForge_Analysis}{ProteoForge},~\href{https://www.biorxiv.org/content/10.64898/2025.12.12.694008}{Preprint})
\end{list2}
\end{list2}
