...
{\em Bioinformatics}
\begin{list1}
\item[]  PhD, Bioinformatics, May 2019 - April, 2025
\begin{list2}
\vspace*{.05in}
\item {\bf Advisor:}  Philipp F. Lange
\item {\bf Thesis Title:}  \href{https://open.library.ubc.ca/cIRcle/collections/ubctheses/24/items/1.0448334}{``Computational interrogation of proteoform dynamics in pediatric cancer''}
\end{list2}
\end{list1}
...
{\em Bioinformatics}
\begin{list1}
\item[]  MSc, Bioinformatics, Sep 2017 - May 2019 (Transferred to PhD)
\end{list1}

{\bf North American University (NAU)}, Houston, Texas USA\\
{\em Software Engineering}
\begin{list1}
\item[] BSc, Computer Science,  Sep 2013 - May 2017
\end{list1}
...
\item Developed a machine learning-based algorithm that can utilize large datasets (approximately 900GB) for estimating TF binding sites.
\end{list2}
\end{list2}
...
Lead student researcher in Bioinformatics Lab at NAU. Mentored 4 junior and sophomore students.\\
Designed an open source bioinformatics curriculum with Open Source Society on GitHub.
...
Wet-lab experience: Worked on drug development and testing process. Prepared agar solutions, bacterial cultures, and conducted liquid/solid drug tests on those cultures.


\section{\sc Teaching \& Mentorship}
{\bf Teaching Assistant}, {\em North American University} \hfill {\bf September 2015 - May 2017}\\
Co-taught 4 undergraduate courses (Algorithms, Programming Languages, Software Engineering, Systems Programming) to over 60 students each semester. Prepared lab and supplementary sessions on Git/GitHub, Python, and Jupyter. Shared responsibilities for lectures, exams, homework, and grading.

{\bf Mathematics and Computer Science Tutor}, {\em North American University} \hfill {\bf January - May 2017}\\
Tutored students in subjects ranging from college algebra to differential equations and from CS1 to Data Mining.

{\bf Instructor}, {\em North American University} \hfill {\bf February - April 2015}\\
